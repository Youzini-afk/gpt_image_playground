...
export interface ApiProfile {
  ...
  providerDrafts?: Partial<Record<ApiProvider, Partial<Pick<ApiProfile, 'baseUrl' | 'model' | 'apiMode' | 'codexCli' | 'apiProxy' | 'editImageField' | 'responseFormatB64Json' | 'streamImages' | 'streamPartialImages'>>>>
}
